            ...
            .withEventHandler(EntityJoinWorldEvent.class,
                (entityJoinWorldEvent, entity, iCharacterStats) -> {
                    if (entityJoinWorldEvent.getEntity() instanceof FishingBobberEntity) {
                        ...
                        PlayerEntity angler = oldEntity.func_234606_i_();
                        if (!oldEntity.getPersistentData().contains("replaced") && angler != null && skill != null) {
                            ItemStack stack = angler.getActiveItemStack();
                            FishingBobberEntity newEntity = new FishingBobberEntity(angler,
                                oldEntity.world,
                            ...
                            newEntity.getPersistentData().putBoolean("replaced", true);
