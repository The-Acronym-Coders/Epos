...
public class Epos {
    ...
    private final JsonLoader<IPath> pathJsonLoader = new JsonLoader<>("path", EposResourceTypes.PATH, IPath.class, EposAPI.PATH_REGISTRY);
    ...
    private void addReloadListeners(AddReloadListenerEvent event) {
        event.addListener(pathJsonLoader);
    }
